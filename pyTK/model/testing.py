...
toPrint.append(printable("avgTeleHighAttempted"))
toPrint.append(printable("pTeleHighAccuracy"))
toPrint.append(printable("avgTeleLowScored"))
toPrint.append(printable("avgTeleLowAttempted"))
toPrint.append(printable("pTeleLowAccuracy"))

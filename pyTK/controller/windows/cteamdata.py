...
class TeamDataController():
    ...
    dataLabelVals = [("numMatch","Number of Matches: "),
                     ...
                     ("avgTeleHighScored","Average Tele Scored in High Goals: "),("avgTeleHighAttempted","Average Tele Attempted in High Goals: "),
                     ("pTeleHighAccuracy","Accuracy in High Goals: "),
                     ("avgTeleLowScored","Average Tele Scored in Low Goals: "),("avgTeleLowAttempted","Average Tele Attempted in Low Goals: "),
                     ("pTeleLowAccuracy","Accuracy in Low Goals: "),
    ...
    graphVals = [("avgOff","Scores","oScores"),("avgDef","Scores","dScores"),
                 ...
                 ("avgTeleScore","Scores","teleScores"),("avgTeleHighScored","Info","teleHighScored"),
                 ("avgTeleHighAttempted","Info","teleHighAttempted"),("avgTeleLowScored","Info","teleLowScored"),
                 ("avgTeleLowAttempted","Info","teleLowAttempted"),("avgTeleTrussScored","Info","teleTrussScored"),
